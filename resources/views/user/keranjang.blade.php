        ...
        @csrf
            ...
            <tbody>
                ...
                <td>
                    ...
                    <input type="text" name="quantity[]" class="form-control text-center" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" value="{{ $keranjang->quantity }}">
                ...
                <td><a href="{{ route('user.keranjang.destroy', $keranjang->id) }}" class="btn btn-primary btn-sm">X</a></td>
                </tr>
                <?php endforeach;?>
            </tbody>
            </table>
