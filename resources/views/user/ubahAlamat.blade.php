        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('user.alamat.update', $item->id) }}" method="POST">
                    @csrf
                        <div class="form-grup">
                            <label for="">Alamat Lengkap</label>
                            <input type="text" name="alamat_detail" id="alamat_detail" placeholde="Kecamatan/Desa/Nama Jalan" class="form-control" value="{{ $item->alamat_detail }}">
                        </select>
                        </div>
