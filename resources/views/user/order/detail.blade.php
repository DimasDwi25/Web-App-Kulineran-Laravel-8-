                ...
                <div class="col-md-8">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>Rp. {{ number_format($order->sub_total + $order->biaya_cod,2,',','.') }}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-4 text-right">
                    @if($order->status_order_id == 4)
                    <a href="{{ route('user.order.pesananditerima',$order->id) }}" onclik="return confirm('Yakin ingin melanjutkan ?')" class="btn btn-primary">Pesanan Di Terima</a><br>
