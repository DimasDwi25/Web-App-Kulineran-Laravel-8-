                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td>Total</td>
                            <td>:</td>
                            <td  class="p-2">Rp. {{ number_format($order->sub_total,2,',','.') }} ( belum Termasuk Ongkir )</td>
                        </tr>
                        <tr>
                            <td>Biaya Ongkir</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td  class="p-2"><a href="{{ route('admin.transaksi.konfirmasi',$order->id) }}" onclick="return confirm('Yakin ingin mengonfirmasi pesanan ini?')" class="btn btn-primary mt-1">Konfirmasi Telah Bayar</a><br>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td  class="p-2">
                            <form action="{{ route('admin.transaksi.inputresi',$order->id) }}" method="POST">
                                @csrf
