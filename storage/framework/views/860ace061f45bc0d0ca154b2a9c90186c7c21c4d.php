...
<div class="bg-light py-3">
    <div class="container">
    <div class="row">
        <div class="col-md-12 mb-0"><a href="<?php echo e(route('home')); ?>">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
    </div>
    </div>
</div>
...
<div class="site-section">
    ...
    <div class="row mb-5">
        ...
        <div class="border p-4 rounded mb-4">
            ...
            <li class="mb-1"><a href="" class="d-flex"><span><?php echo e($categori->name); ?></span> <span class="text-black ml-auto">( <?php echo e($categori->jumlah); ?> )</span></a>
            </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
