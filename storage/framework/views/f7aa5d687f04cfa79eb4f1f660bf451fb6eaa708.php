        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">Kulineran</a>
              </div>
            </div>
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li class="<?php echo e(Request::path() === 'produk' ? '' : ''); ?>"><a href="<?php echo e('produk'); ?>">Produk</a></li>
...
<?php /**PATH D:\Project Laravel\Kulineran\resources\views/user/app.blade.php ENDPATH**/ ?>